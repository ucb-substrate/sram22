...
[SPICE simulation example](https://github.com/ucb-substrate/sram22#spice-simulation).
...
and [BWRC installation](https://github.com/ucb-substrate/sram22#bwrc-installation).
