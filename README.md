...
Valid configurations require positive `num_words` and `write_size`, a data width of
at least 8, a power-of-two `num_words`, a mux ratio of 4 or 8, data width divisible
by write size, at least 16 rows, and at least 16 columns. Address width is `log2(num_words)`;
